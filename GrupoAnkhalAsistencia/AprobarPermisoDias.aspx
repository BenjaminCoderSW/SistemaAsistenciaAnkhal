<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AprobarPermisoDias.aspx.cs" Inherits="GrupoAnkhalAsistencia.AprobarPermisoDias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                        <h2>Gestión de Permisos dias</h2>
    <!-- Grid de datos -->
  <br />
...
<div class="table-responsive">
    ...
    <asp:GridView ID="dvgPermisoDias" runat="server" AutoGenerateColumns="False"
        CssClass="table table-bordered table-striped custom-grid"
        AllowPaging="True" PageSize="5"
        OnPageIndexChanging="dvgPermisoDias_PageIndexChanging">
        <Columns>
