<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImprimirActaHorasExtra.aspx.cs" Inherits="GrupoAnkhalAsistencia.ImprimirActaHorasExtra" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>Acta de Aprobación de Horas Extra</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header-rfc { font-size: 11px; margin-top: 2px; }
        ...
        .row-aprobado { background-color: #d4edda !important; }
        .row-rechazado { background-color: #f8d7da !important; }
        ...
        <div class="container">
            ...
            <div class="header">
                <div>
                    ...
                    <div class="header-subtitle">Acta de Aprobación de Horas Extra</div>
                </div>
                <div>
            ...
            <div class="table-section">
                <asp:Literal ID="litTablaDecisiones" runat="server" />
            </div>
