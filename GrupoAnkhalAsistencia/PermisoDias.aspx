<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PermisoDias.aspx.cs" Inherits="GrupoAnkhalAsistencia.PermisoDias" %>
    ...
    <div class="col-12 col-lg-10 col-xl-8">
      ...
      <div class="card shadow-lg border-0 rounded-3">
        <div class="card-header text-white fw-bold d-flex align-items-center" style="background-color: #003366;">
          <i class="fa fa-clock me-2"></i> Permiso por dias
        </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                <label class="form-label fw-semibold">Fecha Inicio</label>
                  ...
                  <ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtFechaInicio" Format="dd/MM/yyyy"></ajaxToolkit:CalendarExtender>
              </div>
                 <div class="col-md-6">
    ...
    <asp:HiddenField ID="hdnDias" runat="server" />
              ...
              <div class="col-md-6">
                ...
                <asp:TextBox ID="txtTipoPermiso" runat="server" CssClass="form-control"
                  Text="Permiso por dias" ReadOnly="true"></asp:TextBox>
              </div>
            </div>
