<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ComisionHoras.aspx.cs" Inherits="GrupoAnkhalAsistencia.ComisionHoras" %>
    ...
    <div class="col-12 col-lg-10 col-xl-8">
      ...
      <div class="card shadow-lg border-0 rounded-3">
        <div class="card-header text-white fw-bold d-flex align-items-center" style="background-color: #003366;">
          <i class="fa fa-clock me-2"></i> Comisión horas
        </div>
        ...
        <div class="card-body bg-light">
          <asp:Panel ID="pnlPermiso" runat="server">
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                <label class="form-label fw-semibold">Hora Regreso</label>
                <asp:TextBox ID="txtHoraRegreso" runat="server" TextMode="Time"  CssClass="form-control" AutoPostBack="true" OnTextChanged="CalcularHoras" />
              </div>
            </div>
