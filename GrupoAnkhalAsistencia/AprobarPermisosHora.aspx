<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AprobarPermisosHora.aspx.cs" Inherits="GrupoAnkhalAsistencia.AprobarPermisosHora" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                    <h2>Gestión de Permisos Horas</h2>
    <!-- Grid de datos -->
  <br />
...
<div class="table-responsive">
    ...
    <asp:GridView ID="dvgPermisoHoras" runat="server" AutoGenerateColumns="False"
        CssClass="table table-bordered table-striped custom-grid"
        AllowPaging="True" PageSize="5"
        OnPageIndexChanging="dvgPermisoHoras_PageIndexChanging">
        <Columns>
