...
{
    public partial class ReporteComida : System.Web.UI.Page
    {
        ...
        private void CargarHistorialPorFecha(string fecha)
        {
            ...
            var asistencia = from m in db.V_REPORTE_COMIDA
                             where m.Fecha == hoy
        ...
        private void BuscarEmpleado()
        {
            ...
            var query = from m in db.V_REPORTE_COMIDA
                        select m;
    ...
    ";
        ...
        protected void btnExportPDF_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=ReporteComida.pdf");
            ...
            // TÍTULO
            Paragraph titulo = new Paragraph("REPORTE DE COMIDA DEL EMPLEADO\n\n",
        ...
        protected void btnExportExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=ReporteComida.xls");
            Response.Charset = "";
